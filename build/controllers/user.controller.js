...
exports.deleteUser = exports.updateUserRole = exports.getAllUsers = exports.updateProfilePicture = exports.updatePassword = exports.updateUserInfo = exports.socialAuth = exports.getUserInfo = exports.updateAccessToken = exports.logoutUser = exports.loginUser = exports.activeUser = exports.createActivationToken = exports.registrationUser = void 0;
...
exports.activeUser = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
exports.updateAccessToken = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        await redis_1.redis.set(user._id, JSON.stringify(user), "EX", 604800); //604800 means 7 Days
        // res.status(200).json({
        //   status: "Success",
        //   accessToken,
        // });
